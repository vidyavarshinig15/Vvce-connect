import { User, Calendar, LogOut, LayoutDashboard } from 'lucide-react';
      ...
      <aside className="w-64 bg-[#2E8B57] text-white flex flex-col shadow-xl z-10">
        <div className="p-6 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-black tracking-tight leading-none text-white">Faculty</h2>
        ...
        <nav className="flex-1 px-4 space-y-2 mt-8">
          <Link href="/dashboard/faculty" className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/10 transition-colors group">
            <LayoutDashboard size={20} className="text-emerald-100 group-hover:text-white" /> 
            <span className="font-bold text-sm text-white">Venue Booking</span>
          </Link>
          <Link href="/dashboard/faculty/profile" className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/10 transition-colors group">

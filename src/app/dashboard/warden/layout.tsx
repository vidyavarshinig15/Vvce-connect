      ...
      <aside className="w-64 bg-[#738a6e] text-[#FAF9F6] flex flex-col shadow-xl z-10">
        <div className="p-6 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-black tracking-tight leading-none text-[#FAF9F6]">Warden</h2>
        ...
        <nav className="flex-1 px-4 space-y-2 mt-8">
          <Link href="/dashboard/warden" className="flex items-center gap-3 p-3 rounded-xl hover:bg-[#FAF9F6]/10 transition-colors group">
            <Building size={20} className="text-emerald-100 group-hover:text-[#FAF9F6]" /> 
            <span className="font-bold text-sm text-[#FAF9F6]">Dashboard</span>
          </Link>
          <Link href="/dashboard/warden/profile" className="flex items-center gap-3 p-3 rounded-xl hover:bg-[#FAF9F6]/10 transition-colors group">

      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1">
          <div className="bg-[#FAF9F6] rounded-3xl p-8 shadow-sm border border-[#FAF9F6] flex flex-col items-center text-center">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest text-[#738a6e] mt-1">Authorized Warden</p>
        ...
        <form onSubmit={handleSave} className="lg:col-span-2 bg-[#FAF9F6] rounded-3xl p-8 shadow-sm border border-[#FAF9F6]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2 col-span-2">
              ...
              <input disabled={!isEditing} type="text" value={profile.branch} onChange={e => setProfile({...profile, branch: e.target.value})} className="w-full p-3 bg-[#FAF9F6] border border-[#FAF9F6] rounded-xl outline-none focus:border-[#738a6e] disabled:opacity-70" placeholder="e.g. Hostel Administration" />
            </div>
          </div>
